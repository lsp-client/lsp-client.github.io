      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {items.map((item, index) => (
            ...
            >
              <Card className="h-full relative overflow-hidden rounded-2xl border border-border glass transition-all duration-300 hover:shadow-lg hover:border-primary/20">
