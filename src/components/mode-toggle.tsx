...
export function ModeToggle() {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggle}
      className="rounded-full size-10 bg-background/50 backdrop-blur-sm border border-border/50 hover:bg-accent/50 transition-all duration-300 cursor-pointer"
    >
